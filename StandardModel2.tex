...
In this section we will describe the given vessel date, and we will explain how this information is translated into our proposed \emph{Vessel Model} (VM).
...
\begin{figure}[hb]
	...
	\caption{Sections on a vessel. Their endpoints are used as common reference points for cargo-holding structures and hydrostatic constraints in the VM.}
